...
--
CREATE DATABASE IF NOT EXISTS ` minticg2` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE ` minticg2`;
...
INSERT INTO `usuarios` (`id`, `username`, `correo`, `contrasena`) VALUES
